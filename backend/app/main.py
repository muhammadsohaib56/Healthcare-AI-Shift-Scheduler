...
from healthcare_assistant.models import Base, Schedule  # Absolute
from healthcare_assistant.router import router     # Absolute
import uvicorn
...
def seed_data():
    ...
    try:
        # FIXED: Use Schedule.__tablename__ instead of Base.metadata.tables
